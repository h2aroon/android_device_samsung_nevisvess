...
-include vendor/samsung/nevisvess/BoardConfigVendor.mk
...
# Kernel
#TARGET_KERNEL_SOURCE := kernel/samsung/nevisvess
#TARGET_KERNEL_CONFIG := cyanogenmod_nevisvess_defconfig
...
# Prebuilt kernel
TARGET_PREBUILT_KERNEL := device/samsung/nevisvess/kernel/zImage

TARGET_USERIMAGES_USE_EXT4 := true

BOARD_BOOTIMAGE_PARTITION_SIZE := 8590336
BOARD_RECOVERYIMAGE_PARTITION_SIZE := 8590336
BOARD_SYSTEMIMAGE_PARTITION_SIZE := 1050673152
BOARD_USERDATAIMAGE_PARTITION_SIZE := 2278555648
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/samsung/nevisvess/bluetooth
BOARD_BLUEDROID_VENDOR_CONF := device/samsung/nevisvess/bluetooth/libbt_vndcfg.txt
...
BOARD_EGL_CFG := device/samsung/nevisvess/configs/egl.cfg
...
# RIL
BOARD_RIL_CLASS := ../../../device/samsung/nevisvess/ril/

# Recovery
TARGET_RECOVERY_FSTAB := device/samsung/nevisvess/recovery/fstab.rhea_ss_nevisvess
...
# CMHW
BOARD_HARDWARE_CLASS := hardware/samsung/cmhw/ device/samsung/nevisvess/cmhw/

# SELinux
BOARD_SEPOLICY_DIRS += \
    device/samsung/nevisvess/sepolicy
